...
const Reservation = () => {
  return (
    <>
        <h3 className="text-base font-medium pt-2 pl-5"><span className='bg-slate-800 rounded-2xl px-3 text-white'>Reservation</span></h3>  
        <div className='flex p-5'>
            <form className="flex bg-green-200 shadow-md rounded w-full">
                <div className='w-1/2 p-3'>
                    ...
                    <select type='' className="shadow appearance-none border rounded w-full p-1 text-black mb-3">
                ...
                <div className='w-1/2 p-3'>
                    ...
                    <input type='date' className="shadow appearance-none border rounded w-full p-1 text-black mb-3"/>                
                    <label className="block text-black text-sm font-normal mb-1">
                    Reserved Date
                    </label>
                    <input type='date' className="shadow appearance-none border rounded w-full p-1 text-black mb-3"/>
            ...
            <table className='w-full shadow-sm'>
                ...
                <tbody>
                    <tr className='h-10 border-b-2 border-b-gray-200 cursor-pointer hover:bg-slate-200'>
                        ...
                        <td className='px-3 text-center'><button className='text-xs bg-green-500 rounded-lg text-white p-2 hover:bg-green-700 hover:scale-105'>Response</button></td>
                    </tr>
                    <tr className=' h-10 border-b-2 border-b-gray-200 cursor-pointer hover:bg-slate-200'>
                        <td className='px-3 text-center'><span className='text-xs bg-green-700 rounded-lg text-white px-2'>12-10-2020</span></td>
                        <td className='px-3 text-center text-sm font-light'>023878468</td>
