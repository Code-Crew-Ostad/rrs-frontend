...
const RestaurantCard = ({id, img, name, address, type, rating}) => {
    return (
        <div className='font-bold w-[300px] rounded-lg flex flex-col bg-white gap-2  drop-shadow-md'>
            <img className='rounded-t-lg cursor-pointer' src={img} />
            <div className='rounded-lg flex flex-col p-3 gap-2'> 
                ...
                <div className='py-2'>
                <Link to="/details" className=' font-normal bg-[#25916a] hover:opacity-95 text-white border rounded-md h-10 mt-5 text-center p-2 text-sm' >Reserve Now</Link>
                </div>
