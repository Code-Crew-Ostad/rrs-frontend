...
const Footer = () => {
    return (
        <div>
            <div className="grid grid-cols-2 gap-4 bg-slate-700 text-white bg-gradient-to-r from-green-900 from-10% via-green-600 via-50% to-green-600 to-90%  ">
                ...
                <div className="px-10 pt-20" >
                    <div className="grid grid-cols-2 pl-6 pt-5 shadow-2xl rounded-3xl drop-shadow-md bg-green-700  shadow-green-500">
                        <div>
                            ...
                            <button className="btn mt-8 bg-amber-600 px-4 py-2 rounded-md shadow-md hover:shadow-none">READ MORE</button>
                        </div>
